...
interface ProducttDetailProp {
  id: string;
  products: Array<Product>;
}

const ProductDetail: React.FC<ProducttDetailProp> = ({products, id}) => {
  ...
  return (
    ...
    14.26l.03.06c.09.17.19.33.31.48.37.46.92.74 1.5.74h7c.83 
    0 1.54-.5 1.84-1.22l3.02-6.79A1 1 0 0 0 20 
    6H6.21l-.94-2H2v2h2l3.6 7.59-.44.67z"
                  />
                </svg>
                Add to Cart
              </button>
              <button className="w-full bg-transparent border border-brand-green text-brand-green font-bold py-4 px-6 rounded-lg text-lg hover:bg-brand-green/10 transition-colors flex items-center justify-center gap-2">
                <svg
                  ...
                  fill="#00A859"
                >
                  <path d="M11 21h-1l1-7H7.5a1 1 0 0 1-.92-1.39l4-9A1 1 0 0 1 11.5 3H15a1 1 0 0 1 .92 1.39L13 11h3.5a1 1 0 0 1 .92 1.39l-4 9A1 1 0 0 1 12.5 22H11z" />
                </svg>
                Buy Now
              </button>
            </div>
