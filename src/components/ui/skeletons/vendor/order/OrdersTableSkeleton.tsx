...
import OrderCardMobileSkeleton from "./OrderCardMobileSkeleton";

export default function OrdersTableSkeleton() {
  return (
    <>
      <div className="lg:hidden space-y-4 p-4">
        {<OrderCardMobileSkeleton />}
      </div>
      <div className="hidden lg:flex bg-white rounded-3xl border border-[#bbcac1] shadow-sm overflow-hidden  flex-col animate-pulse">
